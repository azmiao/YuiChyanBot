...
public_address = "bot.594594.xyz"#修改为服务器公网ip
SERVICE_MODE = True # true为服务模式，即读取插件名字和插件help
...
def get_readme_path(module_name):
    ...
    base = os.path.join(os.getcwd(), 'yuiChyan', 'plugins', module_name)
    readme_path = None
